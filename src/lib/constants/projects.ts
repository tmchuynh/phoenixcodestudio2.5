...
export const pastProjects: Project[] = [
  {
    ...
    tags: ["Brand Storytelling", "Website Redesign", "Content Creation"],
  ...
  },
  {
    ...
    tags: ["Content Creation", "Brand Storytelling", "Technical Writing"],
    tech: {
      languages: ["TypeScript"],
      frameworks: ["Next.js"],
      libraries: ["React"],
      technologies: ["motion", "react-chartjs-2", "embla-carousel"],
    },
  ...
  },
  {
    ...
    tags: ["Website Redesign", "E-commerce"],
    tech: {
      languages: ["TypeScript"],
      frameworks: ["Next.js", "Tailwind CSS"],
      libraries: ["React"],
      technologies: ["motion", "recharts"],
    },
    githubLink: "https://github.com/tmchuynh/custom-ecommerce",
    liveLink: "https://custom-ecommerce-eta.vercel.app/",
  },
  {
    title: "PixelMind Labs",
    slogan: "Where Imagination Meets Code",
    short:
      "A creative digital agency specializing in custom web solutions, blending innovative design with cutting-edge technology to deliver exceptional user experiences.",
    quote:
      "In a world driven by technology, we believe every child deserves the opportunity not just to keep up—but to lead. Our mission is to democratize access to high-quality computer science education for students of all backgrounds. We aim to instill technical fluency, creative confidence, and a problem-solving mindset that empowers children to shape their futures and impact their communities through innovation. What began as a local after-school program has grown into a thriving educational movement, offering both in-person and online learning experiences for students ages 7–18. Today, we serve hundreds of families through year-round programs, summer camps, and school partnerships.",
    featured: true,
    description:
      "The future will be written in code. From healthcare and climate science to entertainment and art, nearly every industry is being transformed by technology. Yet, access to computer science education remains unequal. Many students—especially those from underrepresented communities—are left out of this transformation.",
    tags: [
      "Brand Storytelling",
      "Website Redesign",
      "Content Creation",
    ...
    githubLink: "https://github.com/tmchuynh/coding-courses",
    liveLink: "https://coding-courses-delta.vercel.app/",
  },
  {
    title: "Fiscora Financial",
    slogan: "Empowering Your Financial Future",
    short:
      "A modern financial services platform designed to simplify personal finance management, offering intuitive tools and resources for smarter financial decisions.",
    quote:
      "Fiscora Financial is dedicated to empowering individuals and families to take control of their financial futures. Our platform provides intuitive tools and resources that simplify personal finance management, making it easier for users to budget, save, and invest wisely. We believe that everyone deserves access to the knowledge and tools needed to achieve financial security and independence. With a focus on user experience and accessibility, Fiscora Financial is committed to helping our clients make smarter financial decisions that lead to a brighter future.",
    featured: true,
    description:
      "Fiscora Financial was created to empower individuals and families to take control of their financial futures through intuitive, user-friendly tools. The platform aims to simplify personal finance management, making it easier for users to budget, save, and invest wisely. By focusing on accessibility and user experience, Fiscora Financial seeks to democratize financial knowledge and resources, helping clients make informed decisions that lead to long-term financial security.",
    tags: ["Content Creation", "Brand Storytelling"],
    tech: {
      languages: ["TypeScript"],
      frameworks: ["Next.js", "Tailwind CSS"],
      libraries: ["React"],
      technologies: ["react-chartjs-2", "embla-carousel-react", "recharts"],
    },
    githubLink: "https://github.com/tmchuynh/finance-startup",
  },
  {
    title: "InnerLight Elevation",
    slogan: "Elevate Your Mind, Elevate Your Life",
    short:
      "A nonprofit that goes beyond traditional models of mental health support, focusing on community-driven solutions and holistic well-being.",
    quote:
      "InnerLight Elevation was founded in 2021 by a dedicated group of mental health advocates, peer supporters, and licensed clinicians who recognized a widening gap between awareness of mental health issues and equitable access to care. This team came together after witnessing close friends and community members suffer in silence—held back by stigma, financial constraints, cultural misunderstandings, and systemic barriers. They realized that while conversations around mental health were becoming more open, many people still felt isolated and unsupported in their struggles. InnerLight Elevation was born out of a shared vision to change this narrative by providing accessible, compassionate, and culturally competent mental health support.",
    featured: true,

    description:
      "InnerLight Elevation was founded in 2021 by a dedicated group of mental health advocates, peer supporters, and licensed clinicians who recognized a widening gap between awareness of mental health issues and equitable access to care. This team came together after witnessing close friends and community members suffer in silence—held back by stigma, financial constraints, cultural misunderstandings, and systemic barriers.",
    tags: ["Brand Storytelling", "Content Creation", "Website Redesign"],
    tech: {
      languages: ["TypeScript"],
      frameworks: ["Next.js", "Tailwind CSS"],
      libraries: ["React"],
    },
    githubLink: "https://github.com/tmchuynh/mental-health-non-profit",
  },
];
