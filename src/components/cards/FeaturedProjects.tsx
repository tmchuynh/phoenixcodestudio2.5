...
export function FeaturedProject({
  ...
  return (
    <Link href={project.githubLink || project.liveLink || ""} className="group">
      <section
      ...
      >
        ...
        <div className="xl:block lg:hidden xl:col-span-2 mx-4 md:mx-0 -mt-2 lg:mt-0 p-2 border-4 rounded-4xl lg:w-full lg:max-w-lg xl:max-w-none lg:shrink-0"></div>
      </section>
    </Link>
  );
}
